...
def download_files():
    urls = [
        "https://github.com/openai/prm800k/raw/main/prm800k/data/phase1_test.jsonl",
...
def convert_format(data, ONLY_SOLVED):
    ...
    for step in steps:
        ...
        if completions is not None:
            ...
            completions_with_answer = [
                comp for comp in rated_completions if answer_marker in comp["text"]
            ]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "output_file",
        nargs="?",
        help="Name of output file, will be overwritten if it exists",
